  ...
  return (
    <div className="container">
      ...
      <div className="sidebar">
        ...
        <a
          href="https://twitter.com/MollyBloom1989"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://www.linkedin.com/in/annacunnane/"
          target="_blank"
          rel="noreferrer"
        >
      ...
      <div className="content">
        ...
        <p>
          I used to work in book publishing and I recently retrained to become a
          software developer.
        </p>

        <p>
          For the past two years I have been learning web development and I
          built this site using{" "}
          <Link to="https://www.gatsbyjs.com/">
            Gatsby <img src={gatsbyLogo} style={{ width: "20px" }} />
          </Link>
        </p>
        <p>
          ...
          <p>
            ...
            advisor on the National Domestic Abuse Helpline.
          </p>
          Want to get in touch with me? Please use the form below and I will get
